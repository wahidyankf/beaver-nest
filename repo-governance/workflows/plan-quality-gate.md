...
12. Testing names unit/integration/behavior/E2E targets, changes, safe AI steps, setup, results, cleanup, evidence. Playwright work names failure-safe cleanup for created tabs/contexts and explicit handoffs. Authentication follows [test identities](../development/test-identities.md). Flag a live API-boundary plan missing contract/authorization evidence as HIGH.
