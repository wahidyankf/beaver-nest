...
- [Principles](principles/README.md) contain the highest-level constraints.
- [Conventions](conventions/README.md) define repository-wide choices within those principles.
- [Development](development/README.md) defines engineering standards within the principles and conventions.
