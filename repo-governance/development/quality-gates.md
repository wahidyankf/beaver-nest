...
| `test:coverage` | Run the covered test suite and fail below 99% total line coverage. Exclusions must be narrow, justified by generated or non-runtime code, and documented in the project README. Do not lower or game the threshold to pass. |
