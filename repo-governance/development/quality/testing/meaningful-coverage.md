...
floor exists is recorded under [Quality Gates](../../quality-gates.md). Which run
gates coverage, and how each exclusion is named, belong to [Quality Gates](../../quality-gates.md). A
...
[Quality Gates](../../quality-gates.md) forbids. The stack standard names its
native verification.
