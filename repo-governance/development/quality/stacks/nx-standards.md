...
[Quality Gates](../../quality-gates.md) owns target names, prerequisites, which
...
have installed them. Upgrades follow Dependency Bump Policy, with the
migration changes reviewed in the same change.

## Tests

Nx adds no test layer. Each project's tests follow its own packs and
[Quality Gates](../../quality-gates.md). Workspace configuration is declarative and carries
