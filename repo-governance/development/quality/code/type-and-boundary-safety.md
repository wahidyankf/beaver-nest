...
threshold [Quality Gates](../../quality-gates.md) sets, and a strictness option is never relaxed to make a
...
later, in code that never saw the input. [Runtime Flat-File Data](../../../conventions/runtime-flat-file-data.md) and
