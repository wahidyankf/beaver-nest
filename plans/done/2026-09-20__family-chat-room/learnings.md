...
**Resolution, 2026-09-20:** the obligation resurfaced exactly as specified. Phase 8's proof (see Resolution Ledger
entry 15's correction below) verifies the mechanism against an isolated test environment, not the real production
`release:run` pipeline — a real, distinct gap a `plan-execution-checker` audit caught and correctly blocked
archival on. Asked the user to choose between building the missing backend scope now or accepting it as residual
risk for v1; the user chose to descope. Recorded as
[an idea](../../ideas/q2-not-urgent-important/family-chat-real-cutover-subscription-proof.md) for future promotion;
`delivery.md`'s item 4 and the PRD's AC-FC-10 both carry the matching dated closure. Not quietly dropped — formally
and explicitly descoped, with the gap itself preserved for whoever picks the idea back up.
...
## Resolution Ledger — 2026-09-20

Phase 9 reconciliation (delivery.md's own instruction at line 1056 of the pre-2026-09-20 revision: "route each entry
into canonical specifications, tests, code comments, durable documentation, governance, a deduplicated idea, or a
recorded discard reason"). This narrative log itself is retained in full as the permanent audit trail (Pause Safety's
own requirement); "durable owner" below names where each entry's _lasting_ content now lives, distinct from this raw
history. Two structural headings (`Capture Contract`, `Execution Log`) are section scaffolding, not learning entries,
and are excluded.

| #   | Entry (heading)                                                            | Durable owner / discard reason                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | Planning Decisions                                                         | brd.md/prd.md's Locked Product Decisions and Material Decisions sections carry every durable choice made here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 2   | Rejected Alternatives                                                      | Discarded by design — recorded here only to prevent re-litigation; no lasting artifact needed beyond this note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 3   | Open Execution Questions                                                   | Each question resolved during execution; its answer lives in the relevant Delivery Phase Execution entry below or the corresponding delivery.md item's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 4   | Historical Quality Gate                                                    | Superseded by Authoring Quality Gate (next entry); retained only as prior context.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 5   | Authoring Quality Gate                                                     | Durable owner: delivery.md Phase 0 item 1's dated note (cites this verdict as the basis for the user-waived fresh gate).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 6   | Phase 0 — Authorized Start and Preflight                                   | Durable owner: delivery.md Phase 0's own dated notes (items 1–4), which restate every material fact here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 7   | Final Readiness Audit                                                      | Durable owner: delivery.md Phase 0 item 1's dated note, which cites this exact audit as its non-blocking verdict basis.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 8   | Delivery Phase 0 Execution                                                 | Durable owner: delivery.md Phase 0's dated notes; this entry is the detailed backing evidence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 9   | Delivery Phase 1 Execution                                                 | Durable owner: delivery.md Phase 1's dated notes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 10  | Production-Data Safety Check During Phase 1                                | Durable owner: delivery.md Phase 1's own proof notes and the test-identities.md convention this session already follows; no separate artifact needed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 11  | Item 5 Resolution — `BE_E2E` Real Root Cause and Old-Topology Retirement   | Durable owner: the `baseURL` fix itself, live in `apps/bnest-app-fe-e2e/playwright.config.mts`; summarized in delivery.md Phase 1 item 5's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 12  | Delivery Phase 2 Execution                                                 | Durable owner: delivery.md Phase 2's dated notes plus the 255-row ledger at `generated-reports/family-chat-room-phase2-gherkin-review.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 13  | Delivery Phase 3 Execution                                                 | Durable owner: delivery.md Phase 3's dated notes (items 1–6), which restate every fix and proof here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 14  | Delivery Phase 4 Execution                                                 | Durable owner: delivery.md Phase 4's dated notes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 15  | Coordinator Decision — Phase 4 Item 4 Deferral                             | Durable owner: delivery.md Phase 4 item 4's own dated note (still open, deferred pending backend scope — not discarded). **Correction, 2026-09-20 (supersedes this entry's own earlier "confirmed satisfied" note from the same day):** that earlier note was wrong — it credited `experience-release-e2e` with proving Caddy-triggered prior-socket-close/catch-up, but that scenario's two members open the room only _after_ promotion (`experience-release.steps.ts`'s own header comment says so), so it never had a pre-promotion socket to prove continuity of. The `plan-execution-checker` agent caught this by reading the cited step code rather than trusting the claim, and correctly blocked archival over it — an instance of the exact failure mode this file's own `plan-verifying-execution` discipline exists to catch, this time inside this file's own reconciliation output. The forward obligation is now genuinely satisfied instead: `family_chat.feature`'s "A connected client reconnects to the promoted slot without a page refresh" was strengthened from two vacuous assertions to a real exact-once-catch-up-plus-queued-drain proof (`apps/bnest-app-fe-e2e/tests/support/family-chat.ts`'s `promoteWithConcurrentTraffic`), verified 4/4 across all three browser projects plus a 41/41 full-suite regression re-run. See delivery.md Phase 8 item 2's own 2026-09-20 correction note for the full account. What remains genuinely unproven is unchanged from this entry's original scope: continuity through the _real_ `tools/release.mjs`/`tools/deployment.mjs` production pipeline itself, still blocked on backend scope this plan never added. **Final resolution, 2026-09-20:** formally descoped for v1 by explicit user decision after the plan-execution-checker audit reconfirmed the real-pipeline gap; recorded as an idea at `plans/ideas/q2-not-urgent-important/family-chat-real-cutover-subscription-proof.md` rather than left open indefinitely. |
| 16  | Delivery Phase 5 Execution                                                 | Durable owner: delivery.md Phase 5's dated notes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 17  | Delivery Phase 5 Execution — Continued                                     | Durable owner: delivery.md Phase 5's dated notes; this entry is the detailed backing evidence for items resumed after a session break.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 18  | Post-resumption reverification and lint gate finding                       | Durable owner: delivery.md Phase 5's dated notes; the lint fix itself is live in the codebase.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 19  | BEHAVIOUR gate genuinely failing — found and fixed                         | Durable owner: delivery.md Phase 5's dated notes; the fix itself is live in the codebase.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 20  | Items 1, 3, 4 ticked                                                       | Durable owner: delivery.md Phase 5 items 1/3/4's own dated notes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 21  | Item 2 closed — focused `FE_E2E` for Cache Storage                         | Durable owner: delivery.md Phase 5 item 2's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 22  | Item 5 closed — routed/integration-layer concurrent-write load proof       | Durable owner: delivery.md Phase 5 item 5's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 23  | Item 6 closed — Scheduler→handler→service→store dependency-direction test  | Durable owner: delivery.md Phase 5 item 6's dated note; the dependency-direction test itself is live in the codebase.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 24  | Item 7 — Phase 5 blocking checkpoint evaluated and ticked                  | Durable owner: delivery.md Phase 5's blocking-checkpoint dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 25  | Delivery Phase 6 Execution                                                 | Durable owner: delivery.md Phase 6's dated notes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 26  | Pre-Phase-7 Candidate-Boot Investigation                                   | Durable owner: delivery.md Phase 7 item 1's dated note (PR #44, the VAPID env-var fix this investigation led to).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 27  | Phase 7 Execution                                                          | Durable owner: delivery.md Phase 7 item 1's dated note (PR #42/#43/#44).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 28  | Scheduler-Restart Race — Root Cause and Fix                                | Durable owner: delivery.md Phase 7 item 1's dated note; fix landed as PR #43, `9c69dca51`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 29  | Phase 7 `release:run` — First Real Attempt                                 | Durable owner: delivery.md Phase 7 item 2's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 30  | Phase 7 `release:run` Attempt 2                                            | Durable owner: delivery.md Phase 7 item 2's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 31  | Phase 7 `release:run` Attempt 3 — Succeeded                                | Durable owner: delivery.md Phase 7 item 2's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 32  | Phase 7 Item 3 — A Fourth Gap: Backup Convergence                          | Durable owner: delivery.md Phase 7 item 3's dated note; fix landed as PR #46.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 33  | PR #45 CI — Order-Dependent Flake in the New Retention Scenario            | Durable owner: PR #45's own fix, live in the codebase; no separate durable document needed beyond this record.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 34  | Phase 7 `release:run` Attempt 4 — A Fifth Gap                              | Durable owner: delivery.md Phase 7 item 3's dated note; fix on branch `fix-family-chat-standalone-repo-start`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 35  | Phase 7 `release:run` Attempt 5 — Succeeded                                | Durable owner: delivery.md Phase 7 item 3's dated note (checked off).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 36  | Phase 8 Experience Release E2E — `StorageCoordinator` Concurrency          | Durable owner: delivery.md Phase 8's dated notes; fix landed as PR #51.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 37  | Phase 8 `executeExperienceRelease` Tooling                                 | Durable owner: delivery.md Phase 8's dated notes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 38  | Phase 8 — Pre-Experience Compatibility Release                             | Durable owner: delivery.md Phase 8 item 1's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 39  | Phase 8 — Managed Experience Release                                       | Durable owner: delivery.md Phase 8 item 2's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 40  | Phase 8 — Backup Restore Drill                                             | Durable owner: delivery.md Phase 8 item 3's dated note.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 41  | Phase 8.5 — Post-Launch Production Fixes                                   | Durable owner: delivery.md Phase 8.5's dated notes (all five items and the blocking checkpoint).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 42  | Display name bug                                                           | Durable owner: delivery.md Phase 8.5's first item; landed as PR #55, `621d41265`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 43  | Visibility-resume bug                                                      | Durable owner: delivery.md Phase 8.5's second item; landed as PR #56, `4138fedad`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 44  | Subscription-channel crash-loop bug                                        | Durable owner: delivery.md Phase 8.5's third item; landed as PR #58, `ff71238dfae5b0a5915ac7b83f1442a414d28cfc`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 45  | Dev-boot socket origin-check bug                                           | Durable owner: delivery.md Phase 8.5's fourth item; landed as PR #59, `71af21cb3ee6755ff7e735ae862f2d7afb4115f6`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 46  | Hi-fi visual design implementation and manual-review findings              | Durable owner: delivery.md Phase 8.5's fifth item; landed as PR #60, `f957862a7a3f4f23a98c73c8a8c4beee731fc608`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 47  | Real IndexedDB persistence for the offline outbox                          | Durable owner: delivery.md Phase 9's second item; landed as PR #63, `d6a70012a9391944dfa14675fcdca8b26f968b5a`. The as-built schema divergence it introduced (object store/index/key shape, transient `Sending`/`Sent` persistence) is now documented in tech-doc 002's "IndexedDB Outbox" section rather than left implicit.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 48  | Historical sender display names still showing raw user IDs                 | Durable owner: delivery.md Phase 9's third/fourth items; landed as PR #69, `b7275752e01588a31a24416204c342bc1a7a39c2`, documented via PR #70, `f28196196`. Released to production 2026-09-20 (revision `f2819619617f5d62be6348ef6d73932c075a6056`, compatibility release then `--mode experience` re-promotion, both `outcome: "passed"`, independently routed-verified). Root cause and rejected alternative recorded in a dedicated section immediately below this table.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 49  | Gherkin-implementation-review audit — five fabricated-proof findings fixed | Durable owner: the fixes themselves, live in the codebase; landed as PR #73, `b03a8da7f`. Full root-cause/fix account, plus the manual-testing decision, in a dedicated section at the end of this file.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |

### Historical sender display name bug — root cause and rejected data-patch alternative, 2026-09-20

PR #55 (Phase 8.5) fixed the _send_ path so new messages carry the real session-derived `displayUsername`, but a
production user reported historical messages still showed the raw user ID after that fix shipped. First hypothesis:
a one-off backfill script correcting the stored `family_chat_messages.sender_display_name` column for the affected
rows. Wrote a dry-run-by-default Python script (`backfill_family_chat_display_names.py`, kept only in the session
scratchpad, never committed) that read the real production SQLite database read-only, cross-referenced
`bnest_records` (`record_type='account'`) for each affected sender's current `displayUsername`, and reported exactly
what it would change. Dry run confirmed two affected accounts and their correct target values. Running it with
`--apply` failed immediately: `sqlite3.IntegrityError: family chat messages are immutable` -- `family_chat_messages`
carries a deliberate DB-level trigger enforcing append-only/audit-log semantics (confirmed in the migration; not a
bug). The data-patch approach was correctly abandoned at that point rather than working around the trigger, and the
user was given a genuine choice between leaving historical messages as-is or resolving display names live at read
time; the user chose live resolution. The real fix (`BnestApp.Identity.display_name_for/1` +
`BnestApp.FamilyChat.live_sender_display_name/2`, wired into the `sender_display_name` GraphQL field's resolver)
leaves the immutable column completely untouched and instead resolves the _displayed_ name against the sender's
current account at query/subscription-push time, with a `system`-kind short-circuit (no account exists) and a
stored-value fallback for a deleted account. Gherkin-first: a new scenario proves both branches, bound genuinely at
both the unit layer (the real function, with an injected account-lookup double -- no filesystem-backed identity store
exists at that layer) and the integration layer (a real GraphQL round trip against a real, renamed test account).

**New item found during this reconciliation pass, not a pre-existing learnings.md entry:** the transient-write edge case
tech-doc 002 now documents (a hard crash landing in the sub-millisecond window between a `Sent` row's write and its
zero-delay scheduled deletion could leave an orphaned row that `resumeOnOpen` does not clean up on next load) is a
genuine, low-probability, low-severity residual gap. Disposition: **discarded as a dedicated delivery item** — the
probability and blast radius (one orphaned row rendered as an extra "Sent" bubble, never a data-loss or duplicate-send
risk) do not justify a new RED/GREEN cycle on top of an already-shipped, tested, production-live fix; documented in
tech-doc 002 rather than hidden, per this plan's own established practice of disclosing rather than silently dropping
known gaps (compare the Phase 4 item 4 deferral above).

### Gherkin-implementation-review audit — five fabricated-proof findings fixed, 2026-09-20

A `repo-governance/workflows/gherkin-implementation-review.md` audit against
`specs/apps/bnest/app-be/behaviours/family_chat_graphql.feature` (triggered by this plan's own delivery, per that
workflow's "changed Gherkin/adapters need the manual review" rule) found five scenarios whose bindings _looked_ green
but did not genuinely prove what their Gherkin text claimed — each fixed in place on branch
`family-chat-gherkin-fixes` with a real RED (the new assertion demonstrated failing against the original,
unfixed production behavior) before GREEN. No `.feature` text changed; no currently-passing check was weakened.

1. **"A subscriber receives exactly one event per committed message" (unit).** The unit driver incremented an
   unconditional counter (`family_chat_subscription_events`) on every message send, regardless of whether Absinthe or
   PubSub genuinely delivered anything, and had no real duplicate-retry action for "publishes no second event" at all.
   Fixed by genuinely running the real subscription document through `Absinthe.run/3` against `BnestAppWeb.Schema`
   (exercising the real `FamilyChatResolver.subscription_config/2` authorization/topic derivation), then
   `Phoenix.PubSub.subscribe/2`-ing this same test process to the real topic Absinthe hands back, and receiving the
   real `%Phoenix.Socket.Broadcast{}` that `FamilyChat.send_message/5`'s real commit-then-publish chain delivers.
   `mix test --no-start` never boots `BnestApp.Application`, so a new `ensure_family_chat_subscriptions_started!/0`
   helper starts the minimal real process tree this needs (`Phoenix.PubSub`, the real `BnestAppWeb.Endpoint` process
   -- `server: false` in `config/test.exs`, so no HTTP listener opens -- and `Absinthe.Subscription`), idempotently;
   the unit-layer boundary scan forbids the Process module, so idempotency is proven by pattern-matching each start
   attempt's own result rather than pre-checking. The "no duplicate publish" outcome now genuinely resends the same
   client message ID and asserts no second broadcast arrives within a bounded timeout, exercising the real
   `FamilyChat.commit_message/6` idempotency lookup instead of re-reading the same fake counter. RED: made `publish/1`
   a no-op -- "receives exactly one event" failed as expected (timeout, no broadcast); reverted. Made the dedup
   branch also call `publish/1` -- "no duplicate publish" failed as expected (a second broadcast arrived); reverted.
2. **"A mutation without a valid CSRF token is rejected" (unit).** The unit driver hardcoded the literal
   `{:error, %{code: "CSRF_REJECTED", ...}}` response shape, never invoking any real CSRF-checking code. Fixed by
   building a genuine `Plug.Conn` via `Plug.Test.conn/3` + `Plug.Session` + `Plug.Conn.fetch_session/1` (a real,
   empty fetched session -- no cookie, no CSRF token in params or header -- never Phoenix's ConnTest helper, forbidden
   at this layer) and calling `BnestAppWeb.Plugs.GraphQLPipeline.call/2` for real, asserting on its genuine 403
   response body. RED: temporarily bypassed `check_csrf/1`'s real `Plug.CSRFProtection` call -- the scenario failed
   as expected; reverted.
3. **"Socket parameters claiming another identity or role are ignored" (unit + integration).** No step ever sent
   spoofed identity params; the check only ever exercised a legitimately authenticated connect. Fixed by building a
   bare `%Phoenix.Socket{}` (no enforced keys, so no live transport is needed) and calling the real
   `BnestAppWeb.UserSocket.connect/3` with both a real session-derived identity and spoofed `userId`/`role` socket
   params together, asserting the resolved context matches only the real session identity. RED: temporarily changed
   `connect/3` to trust the spoofed params instead of the session -- failed as expected at both layers; reverted. A
   coverage regression this introduced (`FamilyChat.socket_context_for(nil)`'s clause becoming unreachable through the
   new code path) was fixed by adding a direct unit test for that clause, restoring the required 99.00% threshold
   (confirmed back at 99.07%).
4. **"GraphiQL is absent from a production-configured endpoint" (unit + integration).** The `family_chat_env: :prod`
   context key was set but never read by anything; the check just inspected the ordinary test-env-compiled router,
   which never carries GraphiQL regardless of the real `dev_routes` flag's value, so the check was trivially always
   true. Fixed by adding a small, safe, behavior-preserving `BnestAppWeb.Router.dev_routes_enabled?/0` accessor
   exposing the exact compile-time-captured `dev_routes` module attribute the router's own mounting `if` gate uses
   (`if @dev_routes_enabled? do` -- identically dead-code-eliminated in a production build as the prior inline
   `Application.compile_env(...)` gate was). The unit layer now asserts the real compiled router's routes never carry
   GraphiQL _and_ that this accessor reports `false`, catching a regression where the mounting decision diverges from
   the reported flag (e.g. a hardcoded `if true`). The integration layer additionally reads the real
   `config/prod.exs` via `Config.Reader.read!/2` (file access is integration-only), catching an actual
   production-config regression the unit layer structurally cannot see. RED: (a) hardcoded `if true` in the router
   while leaving the accessor reporting the real value -- the unit scenario failed as expected; reverted. (b) added
   `dev_routes: true` to `config/prod.exs` -- the integration scenario failed as expected; reverted.
5. **"A member reads the Web Push configuration" (unit + integration).** `match?({:ok, %{}}, ...)` accepted any
   shape, so it never actually validated public-key presence or absence against real VAPID configuration state.
   Fixed by asserting the returned `public_key` genuinely equals the real configured VAPID public key when
   configured, and by genuinely toggling VAPID off (mirroring `push_notifications_test.exs`'s own technique) and
   re-querying to prove the key is genuinely omitted when unconfigured, at both layers. RED: temporarily made the
   unconfigured branch leak a fallback public key -- two unit failures (the BDD scenario plus the pre-existing
   `push_notifications_test.exs` unit test) and one integration failure, all as expected; reverted.

Two unit driver comments written during finding 1/4's fix (and two pre-existing ones from findings 2/3) needed
rewording -- they named the forbidden patterns literally (e.g. `` `File.` ``, `` `Process.` ``,
`` `Phoenix.ConnTest` ``) inside prose explaining why those patterns are forbidden, which is itself exactly the
literal text `test/behaviour/verify.exs`'s boundary scan matches against (it greps raw file contents, not code vs.
comments). Reworded to describe the same modules/helpers without the literal dotted form.

Final verification (all green): `nx run bnest-app:test:unit` (289 backend + 93 frontend tests, 0 failures, 99.07%
total backend coverage); `nx run bnest-app:test:integration` (302 tests, 0 failures, 14 excluded); `nx run
bnest-app:test:coverage:behaviour` (passed -- 403 bindings at each layer, plus the frontend binding-coverage check);
`nx run bnest-app-be-e2e:test:e2e -- --grep "Family chat GraphQL API"` (3 passed, including both
`@integration-exempt` subscription scenarios' alternative e2e proof).

Landing this as PR #73 (never bypassed with `--no-verify`) surfaced three further genuine gate findings, fixed in
place before the push succeeded:

- **A real Dialyzer `pattern_match` failure** in finding 1's new `Absinthe.run/3` call. Absinthe's own published
  typespec only covers the query/mutation success shape (an `:ok`/`:error` tuple carrying `data`/`errors` keys or a
  plain error string), not the ad hoc `{:ok, %{"subscribed" => topic}}` a subscription document actually returns at runtime
  through `Absinthe.Phase.Subscription.SubscribeSelf` -- a known, deliberate gap in the library's own spec (the
  Absinthe ecosystem's own test suites run subscriptions the same way), not a defect in this code. Fixed by
  extracting the call into its own small `subscribe_and_get_topic!/2` helper carrying a narrowly scoped
  `@dialyzer {:nowarn_function, ...}`, so the exemption cannot mask a real warning anywhere else in this
  multi-clause driver -- this repository's first such exemption, and deliberately this narrow.
- **A `mix format` finding** on the new `socket_context_for/1` unit test (finding 3's coverage-regression fix) --
  a plain line-length wrap; fixed by running the formatter.
- **A `credo --strict` design suggestion** ("nested modules could be aliased") on finding 2's
  `BnestAppWeb.Plugs.GraphQLPipeline.call/2`/`init/1` calls; fixed by adding the module to the file's existing
  `alias` block.

**Manual testing (the standing instruction's own requirement):** attempted a live browser check of the new
sender-display-name behavior against an isolated `MIX_ENV=test`/`BNEST_TEST_LAYER=integration` dev server
(synthetic `test-user-` identities, per the test-identities convention), using Playwright MCP after the
`claude-in-chrome` extension would not connect. Reaching family chat requires an authenticated session, and this
application's only login path is a real username/password form (or first-run account creation) -- entering a
password or creating an account is prohibited regardless of whether the identity is synthetic, and no non-interactive
session-bootstrap mechanism exists in this codebase's test tooling for a live browser. Asked the user to choose
between logging in themselves or accepting the independent `gherkin-implementation-review` finding above (a real
integration test hitting the real GraphQL endpoint against a real account rename) as sufficient manual-testing
evidence; the user chose the latter. Recorded here rather than silently skipped.
