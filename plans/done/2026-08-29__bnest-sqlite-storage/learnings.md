...
- 2026-08-29 — SQLite activation occurs automatically after verified migration; repository migration rules require legacy flat-file deletion to run through separately authorized retirement work, with no arbitrary waiting period beyond its safety gates.
