...
- [x] `[AI] [AC-05–AC-06]` Input: final production behaviour. Action: update Badakmini C4 responsibility, behaviour map, and project README. Outcome: as-built specs and project guidance match the implemented validator. Proof: links/maps pass and architecture impact is reconciled.
...
- [x] `[AI] [AC-01–AC-07]` Reconcile deterministic proof with all three safe runtime discovery smokes. Outcome: no claim exceeds observed repository or harness behaviour. Proof: dated learnings and no sensitive evidence.
