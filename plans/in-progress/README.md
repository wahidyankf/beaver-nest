...
No plan is in progress. Completed records live in [`../done/`](../done/README.md), and the next candidate is queued in [`../backlogs/`](../backlogs/README.md).

## Directory Map

This stage holds no plan folder.
