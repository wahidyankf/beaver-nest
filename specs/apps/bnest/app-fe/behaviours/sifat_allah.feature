Feature: Revising the 20 attributes of Allah
  ...
  # Exemption(integration): touch gestures require a browser input implementation; alternative-proof: bnest-app-fe-e2e:test:e2e / A child swipes through a learning session
  @integration-exempt
  ...
  # Exemption(integration): browser history navigation requires a browser session; alternative-proof: bnest-app-fe-e2e:test:e2e / Browser Back returns a child from a quiz to the mission
  @integration-exempt
  ...
  # Exemption(integration): touch gestures require a browser input implementation; alternative-proof: bnest-app-fe-e2e:test:e2e / A child swipes through quiz questions
  @integration-exempt
  ...
  # Exemption(integration): combined browser gestures and history are not observable at the local process boundary; alternative-proof: bnest-app-fe-e2e:test:e2e / A child moves through remembered individual questions
  @integration-exempt
