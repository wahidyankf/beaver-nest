...
- **OSE Code Repositories** — the five repositories Open Sharia Enterprise is built and maintained in: [`ose-public`](https://github.com/wahidyankf/ose-public), an unnamed private operations repository, [`rhino`](https://github.com/wahidyankf/rhino), [`hippo`](https://github.com/wahidyankf/hippo), and this one. Navigation, not coupling: independently versioned and released, with no parent repository above them, and no automatic propagation in either direction. See the [vision](../../repo-governance/vision/README.md#ose-public-relationship).
...
- **Docs propagation** — the workflow that carries a change into every human-facing document it affects, removing obsolete ones. The on-request [docs quality gate](../../repo-governance/workflows/docs-quality-gate.md) audits documents and hands findings to it. See [the workflow](../../repo-governance/workflows/docs-propagation.md).
