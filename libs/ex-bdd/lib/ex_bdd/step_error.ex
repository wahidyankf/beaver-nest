defmodule ExBdd.StepError do
  @moduledoc """
  Exception raised when a step in a ExBdd scenario fails.
  ...
  * `step` - The `ExBdd.Gherkin.Step` struct that has no matching definition
  ...
  * `step_history` - A list of previously executed steps with their status
  ...
  Returns a `ExBdd.StepError` struct with a formatted error message and context.
  ...
  """
  @spec missing_step_definition(ExBdd.Gherkin.Step.t(), String.t(), String.t(), list()) :: t()
  ...
  * `step` - The `ExBdd.Gherkin.Step` struct that failed during execution
  ...
  * `step_history` - A list of previously executed steps with their status
  ...
  """
  @spec failed_step(ExBdd.Gherkin.Step.t(), String.t(), term(), String.t(), String.t(), list()) ::
          t()
  ...
  defp format_step_for_suggestion(text) do
    # Simple conversion to use ExBdd Expression placeholders
