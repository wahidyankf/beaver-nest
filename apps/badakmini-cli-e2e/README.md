...
Run from the repository root through `apps/resource-guard/resource-guard run --class ephemeral -- <command>` and the workspace [resource guard](../../repo-governance/development/resource-aware-development.md):
