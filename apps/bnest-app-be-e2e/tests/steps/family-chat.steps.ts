...
// Only the two family_chat_graphql.feature scenarios that a live Absinthe
// subscription push actually requires (every other scenario in that file
// and all of family_chat_operations.feature carry @e2e-exempt, proven
// instead through bnest-app:test:integration; see the exemption comments in
// the feature files themselves).
