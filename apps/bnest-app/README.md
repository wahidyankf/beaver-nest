...
- `lib/bnest_app/family_chat.ex` and `lib/bnest_app/family_chat/` own room/message persistence and the atomic delivery commit consumed by the GraphQL subscription.
