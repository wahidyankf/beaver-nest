...
const featureRoot = path.join(
  workspaceRoot,
  "specs/apps/bnest/app-fe/behaviours",
);
const testsRoot = path.join(workspaceRoot, "apps/bnest-app-fe-e2e/tests");
const playwrightConfig = "apps/bnest-app-fe-e2e/playwright.config.mts";
