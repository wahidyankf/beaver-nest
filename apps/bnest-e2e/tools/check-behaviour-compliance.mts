...
const featureRoot = path.join(workspaceRoot, "specs/bnest/e2e/behaviours");
const testsRoot = path.join(workspaceRoot, "apps/bnest-e2e/tests");
const playwrightConfig = "apps/bnest-e2e/playwright.config.mts";
