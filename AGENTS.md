...
- Run compute-bearing Nx work for every `apps/` and `libs/` project through the [resource guard](repo-governance/development/resource-aware-development.md); never bypass or parallel-retry exit `75`. Recovery/status controls remain direct.
